#Task 3 Password Generator by CodSoft
...
def main():
    ...
    button_generate_password = tk.Button(root, text="Generate Password", command=generatePassword)
    button_generate_password.grid(row=4, column=0, padx=5, pady=10)

    button_accept_password = tk.Button(root, text="Accept", command=acceptPassword)
    button_accept_password.grid(row=4, column=1, padx=5, pady=10)

    button_reset_fields = tk.Button(root, text="Reset", command=resetFields)
